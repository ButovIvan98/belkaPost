    ...
    return <span>
        <svg height="40" viewBox="0 0 87 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="white"></path>
            <path d="M62.3701 32.0501L55.7382 37.9868L59.5107 32.6031L62.3701 32.0501Z" fill="#EFEFEF"></path>
            <path d="M42.5716 27.1834L38.5024 28.2998L0 0L42.5716 27.1834Z" fill="#EFEFEF"></path>
            <path d="M56.4415 57.4149L30.0878 30.6071L38.2364 33.3208L56.4415 57.4149Z" fill="#EFEFEF"></path>
        </svg>
    </span>
}
export default KenguruIcons;